            ...
            <Row>
                <Col span={12} className={"delete-modal-perfume-image-wrapper"}>
                    <img
                        ...
                        alt={perfumeInfo?.productTitle}
                        src={perfumeInfo?.filename}
                    />
                </Col>
                <Col span={12}>
                    <Typography.Text>Are you sure too delete?</Typography.Text>
                    <Typography.Title level={5}>{perfumeInfo?.productr}</Typography.Title>
                    <Typography.Title level={5}>{perfumeInfo?.productTitle}</Typography.Title>
                </Col>
            </Row>
        </Modal>
    );
