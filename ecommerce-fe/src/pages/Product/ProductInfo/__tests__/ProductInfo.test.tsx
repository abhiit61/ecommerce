...
describe("ProductInfo", () => {
    it("should render correctly", () => {
        ...
        expect(wrapper.text().includes(mockFullPerfumeResponse.productTitle)).toBe(true);
        expect(wrapper.text().includes(mockFullPerfumeResponse.productr)).toBe(true);
        ...
        expect(wrapper.find(Description).at(7).text().includes(mockFullPerfumeResponse.productGender)).toBe(true);
