    ...
    return (
        <Row>
            <Col span={12} className={"product-image-wrapper"}>
                <img src={perfume?.filename} alt={perfume?.productTitle} className={"product-image"} />
            </Col>
            <Col span={12}>
                <Row className={"product-header"}>
                    <Col>
                        <Typography.Title level={3}>{perfume?.productTitle}</Typography.Title>
                        <Typography.Title level={4}>{perfume?.productr}</Typography.Title>
                ...
                <Row>
                    ...
                    <Col span={16}>
                        <Description title={perfume?.productGender} />
