        ...
        <Col span={colSpan}>
            <Link to={`${PRODUCT}/${perfume.id}`}>
                <Card
                    ...
                    cover={<img className={"perfume-card-image"} alt={perfume.productTitle} src={perfume.filename} />}
                    hoverable
                    actions={
                        edit
                            ? [
                ...
                >
                    ...
                    <Meta title={perfume.productTitle} description={perfume.productr} style={{ textAlign: "center" }} />
